      ...
      <div class="assign-auth__content">
        ...
        <el-checkbox-group v-model="localCheckLists"
          ...
          <el-form-item label-width="100px"
                        ...
                        size="small">
            <div>
              <el-checkbox label="UNIT_MANAGER">组织管理</el-checkbox>
            </div>
            <div>
              <el-checkbox label="ADMIN_SETTING">管理员设置</el-checkbox>
            </div>
            <div>
              <el-checkbox label="PLATFORM_PARAM_SETTING">平台参数设置</el-checkbox>
            </div>
          </el-form-item>
          <el-form-item label-width="100px"
                        label="审核管理:"
                        size="small">
            <div>
              <el-checkbox label="APPLICATION_AUDIT">用户申请审核</el-checkbox>
            </div>
            <div>
              <el-checkbox label="VERIFICATION_AUDIT">资质认证审核</el-checkbox>
            </div>
          ...
          <el-form-item label-width="100px"
                        ...
                        size="small">
            <div>
              <el-checkbox label="NOTICE_ISSUER">通知管理</el-checkbox>
            </div>
            <div>
              <el-checkbox label="COURSE_MANAGER">课程管理</el-checkbox>
            </div>
            <div>
              <el-checkbox label="QUALIFICATION_MANAGER">资质管理</el-checkbox>
            </div>
            <div>
              <el-checkbox label="PAT_ARCHIVE_MANAGER">档案管理</el-checkbox>
            </div>
            <div>
              <el-checkbox label="LEARNING_MATERIALS_MANAGER">学习资料管理</el-checkbox>
            </div>
          </el-form-item>
          ...
          <el-form-item label-width="100px"
            ...
            <div>
              <el-checkbox label="EXTEND_EMP_SETTING">推广人员设置</el-checkbox>
            </div>
          </el-form-item>
        </el-checkbox-group>
      </div>
